...
dockerops_kwargs = {
    ...
    "mounts": [
        Mount(
            source="/home/dev1/Desktop/240116/airflow-deeplake-ml/data", # Change to your absolute path
            target="/opt/airflow/data/",
            type="bind",
        ),
        Mount(
            source="/home/dev1/Desktop/240116/airflow-deeplake-ml/results", # Change to your absolute path
